...
class FeedDetailViewModel @Inject constructor(
    ...
    init {
        _feed.value = Feed(
            ...
            votes = listOf(
                Vote(description = "중국집", countOfVoter = 10),
                Vote(description = "김밥천국", countOfVoter = 20),
                Vote(description = "국밥집", countOfVoter = 30),
                Vote(description = "편의점", countOfVoter = 50, checked = true),
            ),
